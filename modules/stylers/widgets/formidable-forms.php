...
class Formidable_Forms extends Widget_Base {
	...
	public function get_title() {
		return __( 'Formidable Forms', 'wp-form-styler' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'formidable_form_id',
			[
				'label' => __( 'Form ID i.e. 6', 'wp-form-styler' ),
				'type' => Controls_Manager::TEXT,
				'default' => '',
				'title' => __( 'Enter the ID # of your Formidable Form', 'wp-form-styler' ),				
			]
		);
	...
	protected function render() {
		...
		$selected_form = $settings['formidable_form_id']; 

		echo do_shortcode('[formidable id=' . $selected_form . ']');
